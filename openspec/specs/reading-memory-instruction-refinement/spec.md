# reading-memory-instruction-refinement Specification

## Purpose
TBD - created by syncing change refine-reading-and-memory-instructions-v1. Update Purpose after archive.
