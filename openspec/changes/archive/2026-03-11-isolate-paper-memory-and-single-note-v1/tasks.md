...
- [x] 1.3 编写 `design.md`，说明 `paper_key` 来源、按论文路径隔离和 note snapshot 决策
...
- [x] 2.3 更新 `literature-explainer/scripts/memory_engine.py`，实现按论文拆分 memory 文件和 `stage=note` 覆盖式更新
...
- [x] 3.5 用最小样例验证 dispatcher 子目录隔离、按论文 memory 文件、note 覆盖写入
